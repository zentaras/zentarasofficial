...
//                     <button onClick={() => { onApproveReject(stepData.id, "approve", note); setOpen(false); }} style={{ padding: "7px 20px", background: "var(--green)", color: "#fff", border: "none", borderRadius: "var(--radius-sm)", fontSize: 12, fontWeight: 700, cursor: "pointer", fontFamily: "sans-serif" }}>✓ Approve Step {stepConfig.number}</button>
...
//               <thead style={{ background: "var(--bg-hover)" }}><tr>{["Intern","Project","Step Progress","Review","Status","Actions"].map(h => (<th key={h} style={{ padding: "10px 14px", textAlign: "left", fontFamily: "sans-serif", fontSize: 10, fontWeight: 700, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.7px", borderBottom: "1px solid var(--border)", whiteSpace: "nowrap" }}>{h}</th>))}</tr></thead>
//               <tbody>
//                 {filtered.map(track => {
//                   const meta = PROJECT_META[track.projectKey] ?? { icon: "🎓", color: "#6366f1" };
...
//         <div style={{ marginBottom: 24 }}><h1 style={{ fontFamily: "sans-serif", fontSize: 22, fontWeight: 800, color: "var(--text-primary)", marginBottom: 4 }}>Admin Dashboard</h1><p style={{ fontSize: 13, color: "var(--text-muted)" }}>Manage applicants and internship progress</p></div>
